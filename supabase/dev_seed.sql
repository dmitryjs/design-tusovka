...
values
  (
    ...
    'Базовые навыки и мышление для входа в продуктовый дизайн: от чтения задачи до первых макетов.',
    0,
    now()
  ),
  (
...
values
  (
    'e0000000-0000-4000-8000-000000000021',
    '["Скрин экрана оплаты", "3 проблемы UX", "1 гипотеза улучшения"]'::jsonb,
    '["Figma или PDF с аннотациями", "Резюме до 500 слов"]'::jsonb
  ),
  (
    'e0000000-0000-4000-8000-000000000022',
