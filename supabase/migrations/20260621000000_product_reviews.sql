-- Product reviews (materials, tasks, sections)
...
-- Review eligibility (REV-02: section only via section_order)
...
comment on function public.can_review_product (uuid) is
  'True if the current user may leave a review: entitled material/task, or section bought as a whole (section_order).';
