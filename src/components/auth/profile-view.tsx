      ...
      <section className="space-y-4 border-t border-neutral-200 pt-8">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="space-y-1">
            ...
            <p className="text-sm text-neutral-600">
              Заказы из корзины. Оплата и выдача доступа — на следующих этапах.
            </p>
          </div>
          <Link href="/profile/orders" className={buttonVariants({ variant: "secondary", size: "sm" })}>
            Все заказы
          </Link>
        </div>
        <OrdersList orders={orders} error={ordersError} />
      </section>
    </CatalogDetailShell>
  );
}
