...
export function PopularMaterialCard({ material, className }: PopularMaterialCardProps) {
  ...
  return (
    <article
      className={cn(
        "group/card relative flex h-full min-w-[240px] flex-col overflow-hidden rounded-lg border border-neutral-200 bg-white sm:min-w-[260px] lg:min-w-0",
        className,
      )}
    >
      ...
      <div className="flex flex-1 flex-col p-4 pb-0">
        <h3 className="line-clamp-2 h-10 text-sm leading-5 font-bold text-foreground">
          {material.title}
        </h3>
      </div>
      ...
      <div className="relative mt-auto h-14 shrink-0">
        ...
        <div className="absolute inset-0 flex w-full items-center gap-2 border-t border-neutral-200 bg-white px-3 opacity-0 transition-opacity duration-150 group-hover/card:opacity-100 group-focus-within/card:opacity-100">
          <Button
            type="button"
